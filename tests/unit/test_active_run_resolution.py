...
def test_get_active_run_id_falls_back_when_active_run_is_stale(tmp_path, monkeypatch, caplog) -> None:
    ...
    _write_manifest(runs_dir, "run_20260404_075919_001")
    _write_manifest(runs_dir, "run_20260404_080336_001")

    active_run_file = runs_dir / ".active_run"
    active_run_file.write_text("run_20260404_999999_001\n", encoding="utf-8")
    ...
    assert resolved == "run_20260404_080336_001"
